...
const Warehousing: React.FC = () => {
  ...
  <main className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-8 md:pt-16 pb-16">
    ...
    <div className="relative w-full h-64 md:h-72 flex items-center justify-center mb-12 pt-8 md:pt-6">
      <img
        src="https://images.pexels.com/photos/4481322/pexels-photo-4481322.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750"
        alt="Warehousing Background"
        className="absolute inset-0 w-full h-full object-cover opacity-80"
      />
      <h1 className="relative z-10 text-4xl md:text-5xl font-extrabold text-white text-center drop-shadow-lg">{t('warehousing')}</h1>
    ...
    <div className="max-w-5xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
      ...
      <div className="flex justify-center">
        <img
          src="https://img.freepik.com/free-vector/warehouse-concept-illustration_114360-893.jpg?w=900"
